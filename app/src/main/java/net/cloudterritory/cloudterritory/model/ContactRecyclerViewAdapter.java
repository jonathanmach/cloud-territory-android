...
public class ContactRecyclerViewAdapter
    ...
    public ContactRecyclerViewAdapter(ArrayList<Contact> contactList) {
    ...
    public void onBindViewHolder(ContactViewHolder territoryviewholder, int i) {
        ...
        {
            territoryviewholder.vName.setText("Unknown");
            territoryviewholder.vName.setTypeface(null, Typeface.ITALIC);

        } else{
            territoryviewholder.vName.setText(contact.name);}

        territoryviewholder.vAddress.setText(contact.address);
    ...
    public ContactViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.card_row_contact, viewGroup, false);
